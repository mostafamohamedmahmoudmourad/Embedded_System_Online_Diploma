...
#define Cortex_M3_Interanl_Peripherals_BASE		0xE0000000UL
...
#define NVIC_IRQ39_USART3_Enable 			(NVIC_ISER1 |= 1<<(USART2_IRQ -32))
...
// USART Disable
#define NVIC_IRQ37_USART1_Disable 			(NVIC_ISER1 |= 1<<(USART1_IRQ -32))
#define NVIC_IRQ38_USART2_Disable 			(NVIC_ISER1 |= 1<<(USART2_IRQ -32))
#define NVIC_IRQ39_USART3_Disable 			(NVIC_ISER1 |= 1<<(USART2_IRQ -32))


// SPI Disable
#define NVIC_IRQ35_SPI1_Disable 			(NVIC_ISER1 |= 1<<(SPI1_IRQ -32))// IRQ-32
#define NVIC_IRQ36_SPI2_Disable 			(NVIC_ISER1 |= 1<<(SPI2_IRQ -32))// IRQ-32
