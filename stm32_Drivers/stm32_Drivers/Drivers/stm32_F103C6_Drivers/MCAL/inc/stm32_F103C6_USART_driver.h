...
#ifndef MCAL_INC_STM32_F103C6_USART_DRIVER_H_
#define MCAL_INC_STM32_F103C6_USART_DRIVER_H_
...
typedef struct
{
	...
	uint32_t 	BaudRate;			// Specifies the  baud rate for the communcation
...
#endif /* MCAL_INC_STM32_F103C6_USART_DRIVER_H_ */
