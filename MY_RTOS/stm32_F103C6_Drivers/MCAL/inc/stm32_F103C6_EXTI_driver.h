...
#ifndef MCAL_INC_STM32_F103C6_EXTI_DRIVER_H_
#define MCAL_INC_STM32_F103C6_EXTI_DRIVER_H_
...
typedef struct {
	...
	uint8_t Trigger;					// Specifies the Rising and falling or both trigger
...
#define EXTI0PDP0	(EXTI_GPIO_Mapping_t){EXTI0, GPIOD,GPIO_PIN_0,EXTI0_IRQ}
...
#endif /* MCAL_INC_STM32_F103C6_EXTI_DRIVER_H_ */
