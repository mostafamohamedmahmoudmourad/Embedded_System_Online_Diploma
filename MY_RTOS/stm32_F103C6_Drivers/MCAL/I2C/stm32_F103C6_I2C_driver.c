...
void MCAL_I2C_Init(I2C_TypeDef* I2Cx , I2C_Config_t* I2C_Config)
{
	...
	if(I2C_Config->I2C_Mode == I2C_Mode_I2C)
	{
		...
		temp_REG |= (I2C_Config->I2C_ACK_Control | I2C_Config->General_Call_Address_Detection | I2C_Config->I2C_Mode | I2C_Config->Stretch_Mode );
...
void MCAL_I2C_GPIO_Set_Pins(I2C_TypeDef* I2Cx)
{
	...
	if(I2Cx == I2C1)
	{
		...
		I2C_PinConfig.GPIO_Output_Speed = GPIO_SPEED_10M;
...
void MCAL_I2C_MASTER_RX (I2C_TypeDef* I2Cx ,uint16_t device_Address,uint8_t* Data ,  uint32_t Data_Length , E_STOP_CONDITION Stop ,E_Repeated_Start Start )
{
	...
	if(I2Cx==I2C1)
	{
		if(GL_I2C_Config[0].I2C_ACK_Control== I2C_ACK_Enable)
		{
			I2C_AckConfig(I2Cx,I2C_enable);
		}
	}
	...
	{
		if(GL_I2C_Config[1].I2C_ACK_Control== I2C_ACK_Enable)
		{
			I2C_AckConfig(I2Cx,I2C_enable);
		}
	}
